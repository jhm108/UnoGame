...
public class GamePage2 extends javax.swing.JFrame {
    ...
    boolean caughtAIUno = false;
    ////
    Deck deck = new Deck();
    Player p1 = new Player();
    PlayerHand AI = new PlayerHand();
    ...
    public GamePage2(int player, String difficulty, String name){
        initComponents();
        ...
        System.out.println(";;;; discard Top: " + discardPile.getTopCardInfo());
        ...
        jLabel15.setText(Integer.toString(AI.hand.size()) + " cards");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(aIUno == false && AI.hand.size() < 2){
            caughtAIUno = true;
            jLabel17.setText("Caught AI Uno!");
            AI.hand.add(deck.remove());
            AI.hand.add(deck.remove());
        }
    ...
    public void AIplay(){
        ...
        Cards AiCard = AI.play(discardPile.getTopCardInfo());
