...
public class resultPage extends javax.swing.JFrame {
    ...
    public resultPage() {
        initComponents();
        jLabel3.setText("You win! Wow.");
    }
    
    public resultPage(boolean won){
        initComponents();
       if (won == true){
          jLabel3.setText("You win! Wow.");
       }
       else{
           jLabel3.setText("You lost Boo.");
       }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UNOgif.gif"))); // NOI18N
